  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://backend-self-delta.vercel.app/api/sellerrequest",
        requestBody
      );
    ...
    <div className="container">
      <main>
        <div className="application-form">
          <h2 className="text-center mb-4">Apply For Seller</h2>
          <div className="application-form-detail">
            ...
            <form>
              ...
              {/* Position */}
              <div className="form-group">
                <label htmlFor="position">Tell Us About What You Are Selling *</label>
                <textarea
